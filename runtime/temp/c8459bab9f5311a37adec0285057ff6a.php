<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\PHP\Work\qigong/application/admin\view\nav\edit.html";i:1528179912;s:51:"D:\PHP\Work\qigong\application\admin\view\base.html";i:1527056892;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="layui-form layui-form-pane" action="" method="post">
    <table class="layui-table">
        ...
        <tr>
            ...
            <td>
                <input type="text" value="<?php echo $data['name']; ?>" name="name" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
            </td>
            <td></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" value="<?php echo $data['fore_url']; ?>" name="fore_url" lay-verify="" placeholder="请输入链接地址" autocomplete="off" class="layui-input" readonly>
            </td>
            <td></td>
        </tr>
       ...
       <tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" value="<?php echo $data['title']; ?>" name="title" lay-verify="" placeholder="请输入标题" autocomplete="off" class="layui-input">
            </td>
            <td></td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" value="<?php echo $data['content']; ?>" name="content" lay-verify="" placeholder="请输入描述内容" autocomplete="off" class="layui-input">
            </td>
            <td></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <select name="type">
                    <option value="0" <?php if($data['type'] == 0): ?>selected<?php endif; ?>>顶部</option>
                    <option value="1" <?php if($data['type'] == 1): ?>selected<?php endif; ?>>中部</option>
                    <option value="2" <?php if($data['type'] == 2): ?>selected<?php endif; ?>>底部</option>
                </select>
            </td>
            <td></td>
        </tr>
