<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\PHP\Work\qigong/application/admin\view\lunbo\edit.html";i:1528945648;s:51:"D:\PHP\Work\qigong\application\admin\view\base.html";i:1527056892;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<fieldset class="layui-elem-field layui-field-title">
    <legend>
        <span class="layui-breadcrumb">
            <a href="<?php echo url('admin/lunbo/index'); ?>">轮播管理</a>
            <a><cite>添加</cite></a>
        </span>
    </legend>
    <br>
...
<form class="layui-form layui-form-pane" action="" method="post">
    <table class="layui-table">
        ...
        <tbody>
        <tr>
            <td class="tc" width="10px"><i class="require">*</i>轮播图上传：</td>
            <td>
                ...
                <input id="img_url" class="layui-input" lay-verify="require" type="text" name="img_url" value="<?php echo $data['img_url']; ?>">
            </td>
        </tr>
        <tr>
            <th><i class="require"></i>轮播图链接地址：</th>
            <td>
                <div style="float:left; width: 30%">
                    <input type="text" class="layui-input" lay-verify="" name="href" placeholder="如：www.baidu.com" value="<?php echo $data['href']; ?>">
                </div>
        ...
        <tr>
            ...
            <td>
                <input type="text" class="layui-input" lay-verify="" name="tips" placeholder="这里输入描述" value="<?php echo $data['tips']; ?>">
                <span></span>
            </td>
        </tr>
