<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\PHP\Work\qigong/application/admin\view\nav\index.html";i:1528179503;s:51:"D:\PHP\Work\qigong\application\admin\view\base.html";i:1527056892;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<table class="layui-table">
    ...
    <tr>
        ...
        <td>
            <a href="<?php echo url('admin/nav/edit', ['id' => $v->id]); ?>" class="layui-btn layui-btn-small layui-btn-normal" title="修改"><i class="layui-icon"></i>修改</a>
...
<script>
    ...
    function deleteAction(id) {
        ...
        layer.confirm('您确定要删除这个导航吗？', {
            ...
            //发送post请求
            $.post("<?php echo url('admin/nav/delete'); ?>", {_method:'DELETE','_token':'csrf_token',id:id}, function (data) {
                if(data.errno) {
