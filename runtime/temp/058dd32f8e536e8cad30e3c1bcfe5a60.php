<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"D:\PHP\Work\qigong/application/index\view\news\detail.html";i:1529474562;s:57:"D:\PHP\Work\qigong\application\index\view\public\nav.html";i:1529399214;s:60:"D:\PHP\Work\qigong\application\index\view\public\footer.html";i:1528961524;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<section id="banner" class="news-banner">
    <img class="img-responsive" src="/public/static/index/images/videos.jpg">
</section>
        ...
        <div class="row">
            <div class="col-md-12 article">
                <div class="article-title">
                    <h1 class="text-center"><?php echo $detail['goods_name']; ?></h1>
                </div>
                <div class="article-content">
                    <img class="img-responsive" src="<?php echo $detail['img_url']; ?>">
                    <p><?php echo $detail['goods_desc']; ?></p>
                    <a class="btn btn-danger" href="javascript:window.history.go(-1)" role="button">返回</a>
                </div>
