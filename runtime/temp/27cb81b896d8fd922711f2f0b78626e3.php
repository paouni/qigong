<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\PHP\Work\qigong/application/admin\view\goods\edit.html";i:1529380925;s:51:"D:\PHP\Work\qigong\application\admin\view\base.html";i:1527056892;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td>
                <div style="float:left; width: 100%">
                    <!-- <input type="text" class="layui-input" lay-verify="required" name="goods_name" placeholder="这里输入产品名称" value="<?php echo $data['goods_name']; ?>"> -->
                    <textarea rows="4" cols="100" name="goods_name"><?php echo $data['goods_name']; ?></textarea>
                </div>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="radio" name="category_id[]" value="<?php echo $v->id; ?>" lay-skin="primary" title="<?php echo $v->html; ?><?php echo $v->name; ?>"
                       <?php if(is_array($data['cate']) || $data['cate'] instanceof \think\Collection || $data['cate'] instanceof \think\Paginator): if( count($data['cate'])==0 ) : echo "" ;else: foreach($data['cate'] as $key=>$vv): if($vv['id'] == $v['id']): ?>checked=""<?php endif; endforeach; endif; else: echo "" ;endif; ?> >
                <?php endforeach; endif; else: echo "" ;endif; ?>

                <!--<select name="category_id" id="">
                    <option value="">请选择分类...</option>
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
                    <option value="<?php echo $v->id; ?>" <?php if($data['category_id'] == $v['id']): ?>selected<?php endif; ?>><?php echo $v->html; ?><?php echo $v->name; ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </select>-->
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <div style="float:left; width: 100%">
                    <!-- <input type="text" class="layui-input" lay-verify="required" name="brief2" placeholder="这里输入特色描述" value="<?php echo $data['brief2']; ?>"> -->
                    <textarea rows="4" cols="100" name="brief2"><?php echo $data['brief2']; ?></textarea>
       ...
       <tr>
            ...
            <td>
                <div style="float:left; width: 100%">
                    <input type="radio" name="place" value="0" <?php if($data['place']==0){?>checked<?php }?> title="产品页展示"/>
                    <input type="radio" name="place" value="1" <?php if($data['place']==1){?>checked<?php }?> title="首页展示"/>
                </div>
                <div style="float: left;"> &nbsp;&nbsp;</div>
            </td>
            <td></td>
        ...
        <tr>
            ...
            <td>
                <div style="float:left; width: 100%">
                    <input type="radio" name="hot" value="0" <?php if($data['hot']==0){?>checked<?php }?> title="否"/>
                    <input type="radio" name="hot" value="1" <?php if($data['hot']==1){?>checked<?php }?> title="是"/>
                </div>
                <div style="float: left;"> &nbsp;&nbsp;</div>
            </td>
            <td></td>
        ...
        <tr>
            ...
            <td>
                <div class="site-demo-upload">
                    <img id="LAY_demo_upload" src="<?php echo $data['img_url']; ?>" width="" height="200" alt="点击下面的 上传图片">
                    <div class="site-demo-upbar">
                        <input type="file" name="file" class="layui-upload-file" id="test">
                    </div>
                </div>
                <input id="img_url" class="layui-input" lay-verify="require" type="hidden" name="img_url" value="<?php echo $data['img_url']; ?>">
            </td>
            <td></td>
        </tr>
        <tr>
            ...
            <td style="height: 300px;">
                <div style="height: 260px; margin-bottom: 10px;">
                    <ul class="filelist">
                        <?php if(is_array($data['goods_gallery']) || $data['goods_gallery'] instanceof \think\Collection || $data['goods_gallery'] instanceof \think\Paginator): if( count($data['goods_gallery'])==0 ) : echo "" ;else: foreach($data['goods_gallery'] as $key=>$v): ?>
                        <li style="float: left;margin-right: 10px;">
                            ...
                            <p class="title" onclick="del_parent(this)">点击删除</p>
                            <input type="hidden" name="goods_gallery[]" value="<?php echo $v; ?>">
                        </li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
        ...
        <tr>
            ...
            <td>
                <textarea title="产品详细图文描述" id="editor" name="goods_desc" style="width:100%;height:500px;" nullmsg="请输入文章内容"><?php echo $data['goods_desc']; ?></textarea>
            </td>
            <td></td>
        </tr>
