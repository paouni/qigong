<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"D:\PHP\Work\qigong/application/admin\view\login\login.html";i:1526869418;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="login-box">
    <form class="layui-form layui-form-pane" method="post" action="<?php echo url('index'); ?>">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="code" style="width: 50%;float: left;" class="layui-input" lay-verify="code" placeholder="验证码" maxlength="4"/>
                <img src="<?php echo url('admin/login/verify'); ?>" id="verify" onclick="this.src='<?php echo url("admin/login/verify"); ?>?'+ Math.random()" style="cursor: pointer;" alt="验证码">
            </div>
        </div>
        <div class="layui-form-item">
